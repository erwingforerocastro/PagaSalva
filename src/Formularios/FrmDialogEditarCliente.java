 ...
 * @author Erwing_fc
 */
public class FrmDialogEditarCliente extends javax.swing.JDialog {

    /**
     * Creates new form FrmDialogEditarCliente
     */
    public FrmDialogEditarCliente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnBusacr.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(btnBusacr, javax.swing.GroupLayout.PREFERRED_SIZE, 101, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void btnBusacrActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBusacrActionPerformed
        if(!this.txtDocumento.getText().equals("")){
            Cliente objCliente=FrmInicio.objSistema.mostrarCliente(this.txtDocumento.getText());
            this.txtNombre.setText(objCliente.getNombre());
            if(!this.txtDocumento.getText().equals(objCliente.getId())){
                JOptionPane.showMessageDialog(this,"El documento digitado no se encuentra");
            }
        }else{
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        FrmInicio.objSistema.editarCliente(documento,nombre);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmDialogEditarCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmDialogEditarCliente dialog = new FrmDialogEditarCliente(new javax.swing.JFrame(), true);
